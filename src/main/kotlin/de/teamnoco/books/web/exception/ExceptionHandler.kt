...
class ExceptionHandler {
    ...
    fun handleNoSuchKeyException(e: NoSuchKeyException): ResponseEntity<StatusResponse> =
        StatusResponse.Error("Attachment not found", 404).asResponseEntity()
